...
import getColumns from './ShopsColumns';
import Edit from "@material-ui/icons/Edit";
import { Switch } from "@material-ui/core";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteShops, getShops} from "../../repo/shopsRepo";
...
const ShopsTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {   setLoading(true);
                const res = await getShops(query.page,query.pageSize,query.search);
                setLoading(false);
                return ({
                    data: res.data,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/shops/update/${rowData.id}`,
                        user:rowData
                    })
                }
            },
