...
const ShopsAddUpdatePage = (props) => {
  ...
  return (<PageTemplate title="Add/Update Shops">
    <Card>
      <CardContent>
        <form onSubmit={handleSubmit} noValidate autoComplete="off">

          {(shops !== undefined) ? <Grid spacing={3} container>
            <Grid xs={12} md={6} key={"0"} item>
              <TextField autoFocus fullWidth
                         helperText={errorMessages.market_id}
                         type={"number"}
                         onChange={(e) => {
                           setShops({...shops, market_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"1"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"text"}
                         onChange={(e) => {
                           setShops({...shops, name: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"2"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"text"}
                         onChange={(e) => {
                           setShops({...shops, address: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"3"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setShops({...shops, product_types_count: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"4"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setShops({...shops, products_count: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"5"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setShops({...shops, views: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"6"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"text"}
                         onChange={(e) => {
                           setShops({...shops, photo: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"7"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setShops({...shops, status: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} item key={"8"}>
              <Grid container justify={"flex-end"} alignContent={"flex-end"}>
                <Button onClick={() => history.push('/shops')} variant={"contained"} type={"Button"}
