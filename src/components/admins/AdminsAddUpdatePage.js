...
const AdminsAddUpdatePage = (props) => {
  ...
  return (<PageTemplate title="Add/Update Admins">
    <Card>
      <CardContent>
        <form onSubmit={handleSubmit} noValidate autoComplete="off">

          {(admins !== undefined) ? <Grid spacing={3} container>
            <Grid xs={12} md={6} key={"0"} item>
              <TextField autoFocus fullWidth
                         helperText={errorMessages.shop_id}
                         type={"number"}
                         onChange={(e) => {
                           setAdmins({...admins, shop_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"2"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"text"}
                         onChange={(e) => {
                           setAdmins({...admins, username: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"3"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setAdmins({...admins, phone: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"5"} item>
              <TextField autoFocus fullWidth
                         ...
                         onChange={(e) => {
                           setAdmins({...admins, email_verified_at: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"7"} item>
              <TextField autoFocus fullWidth
                         ...
                         type={"text"}
                         onChange={(e) => {
                           setAdmins({...admins, remember_token: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} item key={"8"}>
              <Grid container justify={"flex-end"} alignContent={"flex-end"}>
                <Button onClick={() => history.push('/admins')} variant={"contained"} type={"Button"}
