...
const ProductsAddUpdatePage = (props) => {
  ...
  return (<PageTemplate title="Add/Update Products">
    <Card>
      <CardContent>
        <form onSubmit={handleSubmit} noValidate autoComplete="off">

          {(products !== undefined) ? <Grid spacing={3} container>
            <Grid xs={12} md={6} key={"0"} item>
              <TextField autoFocus fullWidth
                         helperText={errorMessages.product_type_id}
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, product_type_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"2"} item>
              <TextField autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, market_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"3"} item>
              <TextField autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, shop_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"4"} item>
              <TextField autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, country_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"8"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, discount: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"10"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, views: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"11"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, likes: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"12"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setProducts({...products, sort_order: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} item key={"14"}>
              <Grid container justify={"flex-end"} alignContent={"flex-end"}>
                <Button onClick={() => history.push('/products')} variant={"contained"} type={"Button"}
