...
if(markets.status === "" || markets.status === undefined)
{
   errorList = { ...errorList,status: "Required field!"}
    ...
    return(
        <PageTemplate title="Add/Update Markets">
            <Card>
            <CardContent>
...
type ={"text"}
onChange={(e)=>{setMarkets({...markets,name:e.target.value});checkErrors()}}
...
type ={"text"}
onChange={(e)=>{setMarkets({...markets,address:e.target.value});checkErrors()}}
...
type ={"number"}
onChange={(e)=>{setMarkets({...markets,shops_count:e.target.value});checkErrors()}}
...
type ={"number"}
onChange={(e)=>{setMarkets({...markets,products_count:e.target.value});checkErrors()}}
...
type ={"text"}
onChange={(e)=>{setMarkets({...markets,photo:e.target.value});checkErrors()}}
...
type ={"number"}
onChange={(e)=>{setMarkets({...markets,status:e.target.value});checkErrors()}}
...
<Button onClick={() => history.push('/markets')} variant={"contained"} type={"Button"} color="secondary">Cancel</Button>
</Grid>
</Grid>
