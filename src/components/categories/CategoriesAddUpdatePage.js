...
const CategoriesAddUpdatePage = (props) => {
  ...
  return (<PageTemplate title="Add/Update Categories">
    <Card>
      <CardContent>
        <form onSubmit={handleSubmit} noValidate autoComplete="off">

          {(categories !== undefined) ? <Grid spacing={3} container>
            <Grid xs={12} md={6} key={"0"} item>
              <TextField required autoFocus fullWidth
                         helperText={errorMessages._lft}
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, _lft: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"1"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, _rgt: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"2"} item>
              <TextField autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, parent_id: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"3"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, top: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"4"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, sort_order: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} key={"5"} item>
              <TextField required autoFocus fullWidth
                         ...
                         type={"number"}
                         onChange={(e) => {
                           setCategories({...categories, status: e.target.value});
                           checkErrors()
                         }}
            ...
            <Grid xs={12} md={6} item key={"6"}>
              <Grid container justify={"flex-end"} alignContent={"flex-end"}>
                <Button onClick={() => history.push('/categories')} variant={"contained"} type={"Button"}
