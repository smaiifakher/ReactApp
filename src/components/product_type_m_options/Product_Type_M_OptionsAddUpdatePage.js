...
import {addProduct_Type_M_Options, getProduct_Type_M_Options,getOneProduct_Type_M_Options, updateProduct_Type_M_Options} from "../../repo/product_type_m_optionsRepo";
...
const Product_Type_M_OptionsAddUpdatePage = (props)=>{
    ...
    return(
        <PageTemplate title="Add/Update Product_Type_M_Options">
            <Card>
            <CardContent>
                <form onSubmit={handleSubmit} noValidate autoComplete="off">
               
                    {(product_type_m_options!==undefined )?
                        <Grid spacing={3} container>
                           <Grid xs={12} md={6} key={"0"} item>
<TextField  autoFocus fullWidth
helperText ={errorMessages.product_type_id}
type ={"number"}
onChange={(e)=>{setProduct_Type_M_Options({...product_type_m_options,product_type_id:e.target.value});checkErrors()}}
...
type ={"number"}
onChange={(e)=>{setProduct_Type_M_Options({...product_type_m_options,m_option_id:e.target.value});checkErrors()}}
...
type ={"number"}
onChange={(e)=>{setProduct_Type_M_Options({...product_type_m_options,m_option_value_id:e.target.value});checkErrors()}}
...
<Button onClick={() => history.push('/product_type_m_options')} variant={"contained"} type={"Button"} color="secondary">Cancel</Button>
</Grid>
</Grid>
